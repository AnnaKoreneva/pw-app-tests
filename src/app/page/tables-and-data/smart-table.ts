...
export class SmartTable {
    ...
    async deleteRaw() {
        ...
        await expect(this.page.locator('tbody tr').first()).not.toHaveText('mdo@gmail.com');
    }
    ...
    private async editTableValue(placeholder: string, value: string) {
        await this.page.locator('input-editor').getByPlaceholder(placeholder).clear();
        await this.page.locator('input-editor').getByPlaceholder(placeholder).fill(value);
    }
    ...
    private async columnSearch(placeholder: string, value: string) {
        await this.page.locator('input-filter').getByPlaceholder(placeholder).clear();
        await this.page.locator('input-filter').getByPlaceholder(placeholder).fill(value);
    }
