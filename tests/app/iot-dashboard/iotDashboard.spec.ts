...
test.only('IoT Dashboard: set slider to max using JS and check the temperature value', async ({
    ...
    await AllureHelper.step(
        'set slider to max using JS and check the temperature value',
        async () => {
...
test('IoT Dashboard: set sliders to max using the axis coordinates', async ({ dashboardPage }) => {
    await AllureHelper.step(
        'set slider to max using axis coordinates and check the temperature value',
        async () => {
...
test('IoT Dashboard: set sliders to min using the axis coordinates', async ({ dashboardPage }) => {
    await AllureHelper.step(
        'set slider to min using axis coordinates and check the temperature value',
        async () => {
