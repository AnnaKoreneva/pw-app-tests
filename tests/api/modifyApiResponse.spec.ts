...
test('has title', async ({ page }) => {
  ...
  await expect(page.locator('//app-article-preview[1]//h1')).toContainText(
    'This is the MOCK title',
  );
  await expect(page.locator('app-article-preview p').first()).toContainText(
    'This is the MOCK description',
  );
});
